<%@ Page Title="" Language="C#" MasterPageFile="~/AdminBilge/bindex.Master" AutoEventWireup="true" CodeBehind="updateProduct.aspx.cs" Inherits="TukkanDeko.AdminBilge.updateProduct" %>
        ...
        <div class="bg-secondary rounded h-100 p-4">
            <div class="row g-4">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <div class="bg-secondary rounded h-100 p-0">
                         ...
                         <div class="bg-secondary rounded h-100 pl-2">
                            ...
                            <asp:TextBox ID="tb_profitMargin" runat="server" CssClass="form-control" Placeholder="Barkod"></asp:TextBox>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-xl-6">
                    ...
                    <div class="mb-3">
                        <label for="basic-url" class="form-label">Resim 4</label>
                        <asp:Image ID="img_picture4" runat="server" Style="width: 100px" /><br />
                        <asp:FileUpload ID="fu_picture4" runat="server" CssClass="form-control bg-dark" AllowMultiple="true" />
                    </div>

                    <div class="mb-3">
                        <label for="basic-url" class="form-label">Resim 5</label>
                        <asp:Image ID="img_picture5" runat="server" Style="width: 100px" /><br />
                        <asp:FileUpload ID="fu_picture5" runat="server" CssClass="form-control bg-dark" AllowMultiple="true" />
                    </div>
